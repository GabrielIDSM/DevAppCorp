...
public class AddServiceData implements Runnable {
    ...
    public void run() {
        ...
        String url = (String) systemVariableUtil.toType(systemVariableRepository.getSystemVariable("URL"));
        String maxResult = (String) systemVariableUtil.toType(systemVariableRepository.getSystemVariable("MAX_RESULT"));
        String token = (String) systemVariableUtil.toType(systemVariableRepository.getSystemVariable("TOKEN"));
